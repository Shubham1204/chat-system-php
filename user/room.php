		<div class="col-lg-8">
				...
				<div class="pull-right" style="margin-right:10px; margin-top:7px;">
					<?php
						if ($chatrow['userid']==$_SESSION['id']){
							...
							<a href="#delete_room" data-toggle="modal" class="btn btn-danger"><a href="delete.php">Delete Room</a></a>
							<a href="#add_member" data-toggle="modal" class="btn btn-primary"><a href="addmember.php">Add Member</a></a>
							<?php
						}
						else{
							?>
			...
			<div>
				...
				<div class="input-group">
					...
					<span class="glyphicon glyphicon-comment"></span><a href="room.php"> Send</a>
					</button>
					</span>
				</div>
